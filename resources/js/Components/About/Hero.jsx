...
export default function Hero() {
    return (
        <div className="px-5 lg:px-8 pb-6">
            <div className="md:w-2/3 pb-3 md:pb-6">
                <h1 className="text-2xl lg:text-3xl font-medium py-3">
                    Burma Web Campus{" "}
                </h1>
                <p className="text-gray-800 text-sm lg:text-base">
                    BurmaWebCampus is an online website development learning hub
                    for students in Myanmar with accessible, practical, and
                ...
                <div className="w-full flex flex-col md:flex-row justify-end gap-3">
                    ...
                    <div className="md:w-1/3">
                        <div className="px-3 py-3 border border-gray-500 rounded-lg bg-black text-white">
                            ...
                            <p className="text-gray-300">from your mentor</p>
                        </div>
                    </div>
                </div>
            </div>
